...
1. [PART 5：單句文法與詞彙](#part-5)
   概念：這回 Part 5 題型分佈很廣。有不少題考詞性判斷（例如 105、121、125、129、130，要分辨名詞/形容詞/副詞/動名詞該放在哪個位置），也有幾題考動詞的時態與語態（104、109，注意被動語態與間接引述時態一致的問題）。介系詞與連接詞的邏輯判斷也是重點（106、107、114、117、126、128，像 Although、Given that、Upon、Amid、Instead of 這類轉折或時間邏輯字），另外有一大批單純考詞彙語意的題目（103、108、112、113、115、116、118、120、122、123、127，同詞性中選出語意最適合的字），加上少數代名詞/數量詞/關代題（102、110、119、124）與一題對等結構的不定詞題（111）。整體來說是文法概念與詞彙量並重的一回。
...
3. [PART 7：閱讀理解](#part-7)
   概念：這回 Part 7 涵蓋單篇、雙篇、三篇閱讀，文體包含表單、書信、公告、簡訊對話、線上聊天、新聞報導、網頁、e-mail 和投標表單等。題型很多元，主旨題、wh- 細節題、NOT/True 題、推論題（suggested/implied/indicated）、同義詞題、句子插入題、掌握意圖題都有出現，尤其在雙篇和三篇閱讀中常需要交叉比對不同文件的日期、金額、人名等細節才能作答。（注意：本檔案題號 168-171 那篇 Stryker Amusement Park 的公告在原始素材中沒有 `###` 標題可供錨定，因此目錄中從 164-167 直接跳到 172-175，屬原始素材本身的狀況。）
   1. [Questions 147-148 refer to the following form.](#questions-147-148-refer-to-the-following-form)
      概念：表單文體，是有線電視訂戶申請重新開通服務的表格。考的是 wh- 細節題（取消原因、簽名人是誰），需要對照表格中的勾選欄位與備註文字。
   ...
   10. [Questions 176-180 refer to the following Web page and e-mail.](#questions-176-180-refer-to-the-following-web-page-and-e-mail)
